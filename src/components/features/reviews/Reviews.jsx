	...
	return (
		<div className='reviews-wrapper'>
			...
			<ReviewCard
				...
				rating={5}
				review='SERIOUSNESS, QUALITY and DEDICATION can be seen with the naked eye in the poster!
        The colors and their appearance definitely blew me away and what such a personalized poster can convey is incredible!
