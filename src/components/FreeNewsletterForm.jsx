...
import sendFreePosterForm from '../reducers/actions/sendFreePosterForm';

const FreeNewsletterForm = () => {
	...
	function handleSubmit(e) {
		e.preventDefault();
		sendFreePosterForm(email, dispatch);
	}
	...
	return (
		<div className={classes.container}>
			...
			{newsletterSubmitted != null && (
				<>{newsletterSubmitted === true && <p>You're in!</p>}</>
			)}
		</div>
	);
};

export default FreeNewsletterForm;
