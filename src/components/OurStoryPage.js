			...
			<div className={styles.textContainer}>
				...
				<div className={styles.text}>
					...
					<p className={styles.subheadline}>
						...
						în fiecare casă, iar fiecare poster să se simtă ca o îmbrățisare de
						sine. Suntem dedicați să îndemnăm oamenii să se reconecteze cu
						sinele lor autentic și să exploreze universul creativității prin
						artă și culori. Fiecare poster și ramă este concepută pentru a aduce
						o notă de frumusețe și semnificație în spațiul personal al
